...
import { ProjectMetrics } from './dashboard/ProjectMetrics';
import { MarketStats } from './dashboard/MarketStats';
import { LiveRewardsFeed } from './dashboard/LiveRewardsFeed';
  ...
  if (!isConnected) {
    return (
      <div className="space-y-6">
        ...
        <LiveRewardsFeed liveRewards={liveRewards} stats={stats} />

        {/* Bottom CTA */}
        <CTASection stats={stats} onConnectWallet={onConnectWallet} />
      </div>
    );
  }
